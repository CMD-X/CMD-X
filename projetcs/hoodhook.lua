...
mt.__namecall = newcclosure(function(event, ...)
	if not checkcaller() and event.Name == "SayMessageRequest" and getnamecallmethod() == "FireServer" then
		...
		local GangPhrases2 = {["nothing"] = "ntn", ["are"] = "iz", ["too"] = "2", ["bro"] = "jit", ["what"] = "wat", ["whats up"] = "wassup", ["what is up"] = "wazzup", ["no"] = "naw", ["discord"] = "mic up", ["sure"] = "fr", ["crazy"] = "wildin", ["mommy"] = "momma", ["mummy"] = "mumma", ["wilding"] = "wylin", ["dude"] = "kuh", ["friend"] = "kuh", ["yes"] = "yuh", ["about"] = "bout", ["hey"] = "yo", ["lol"] = "yhu funni", ["talking"] = "talm", ["you"] = "yhu", ["do"] = "dhu", ["who"] = "whu", ["blacc"] = "black", ["alright"] = "aight", ["ok"] = "ightt", ["cop"] = "opp", ["police"] = "12", ["house"] = "crib", ["gun"] = "chrome", ["shit"] = "sh", ["weird"] = "trippin", ["gay"] = "sus", ["girl"] = "shordy", ["fire"] = "fie", ["like"] = "lye", ["black"] = "blacc"}
