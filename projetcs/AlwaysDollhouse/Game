...
local header_2 = Instance.new("ImageLabel")
...
Announce.Position = UDim2.new(0.92, 0, -0.2, 0)
...
UICorner4.Parent = ScrollComplex
...
header.Text = game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name
...
ScrollComplex.Size = UDim2.new(1, 0, 1, 0)
ScrollComplex.ImageTransparency = 0
ScrollComplex.Image = "http://www.roblox.com/Thumbs/Asset.ashx?format=png&width=420&height=230&assetId="..game.PlaceId
ScrollComplex.ScaleType = Enum.ScaleType.Stretch
ScrollComplex.ZIndex = 1
